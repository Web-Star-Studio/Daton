...
export const GetMeResponse = zod.object({
  ...
  "onboardingData": zod.object({
  "companyProfile": zod.object({
  "sector": zod.enum(['manufacturing', 'agro', 'food_beverage', 'mining', 'oil_gas', 'energy', 'chemical', 'pulp_paper', 'steel', 'logistics', 'financial', 'telecom', 'public', 'pharma_cosmetics', 'automotive', 'technology', 'consumer_goods', 'utilities', 'healthcare', 'education', 'retail', 'construction', 'services', 'other']),
  "customSector": zod.string().nullish(),
  "size": zod.enum(['micro', 'small', 'medium', 'large', 'xlarge', 'enterprise']),
  "goals": zod.array(zod.enum(['emissions_reduction', 'environmental_compliance', 'health_safety', 'energy_efficiency', 'water_management', 'waste_reduction', 'sustainability', 'quality', 'compliance', 'performance', 'innovation', 'cost_reduction'])),
  ...
  "modules": zod.array(zod.enum(['documents', 'legislations', 'employees', 'units', 'departments', 'positions', 'governance', 'suppliers', 'environmental']))
})
...
export const ListLegislationsQueryParams = zod.object({
  ...
  "level": zod.enum(['federal', 'estadual', 'municipal', 'internacional']).optional(),
  "unitId": zod.coerce.number().optional().describe('Filter legislations by unit compliance tags')
})
...
export const ImportLegislationsBody = zod.object({
  "legislations": zod.array(zod.object({
  "title": zod.string(),
  "number": zod.string().optional(),
  "description": zod.string().optional(),
  "tipoNorma": zod.string().optional(),
  ...
  "conflictStrategy": zod.enum(['skip', 'update']).optional().describe('How to handle legislations that already exist (matched by tipoNorma + number)')
})
...
export const GetLegislationResponse = zod.object({
  ...
  "createdAt": zod.string().datetime({}),
  "updatedAt": zod.string().datetime({}),
  "unitLegislations": zod.array(zod.object({
  "id": zod.number(),
  "unitId": zod.number(),
  "legislationId": zod.number(),
  "complianceStatus": zod.enum(['conforme', 'nao_conforme', 'parcialmente_conforme', 'nao_avaliado']),
...
export const ListLegislationUnitsResponse = zod.array(ListLegislationUnitsResponseItem)
...
export const AssignLegislationToUnitBody = zod.object({
  "unitId": zod.number(),
  "complianceStatus": zod.enum(['conforme', 'nao_conforme', 'parcialmente_conforme', 'nao_avaliado']).optional(),
...
export const ListUnitLegislationsResponse = zod.array(ListUnitLegislationsResponseItem)
...
export const GetComplianceTagVocabularyResponse = zod.array(GetComplianceTagVocabularyResponseItem)
...
export const ListQuestionnaireThemesResponse = zod.array(ListQuestionnaireThemesResponseItem)
...
export const GetUnitQuestionnaireResponsesResponse = zod.record(zod.string(), zod.unknown())
...
export const GetUnitComplianceTagsResponse = zod.array(GetUnitComplianceTagsResponseItem)
...
export const ListEmployeesQueryParams = zod.object({
  ...
  "pageSize": zod.coerce.number().min(1).max(listEmployeesQueryPageSizeMax).optional()
})
...
export const createEmployeeBodyProfessionalExperiencesItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const createEmployeeBodyEducationCertificationsItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateEmployeeBody = zod.object({
  ...
  "professionalExperiences": zod.array(zod.object({
  "title": zod.string().min(1),
  "description": zod.string().optional(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createEmployeeBodyProfessionalExperiencesItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createEmployeeBodyProfessionalExperiencesItemAttachmentsItemObjectPathRegExp)
})).max(createEmployeeBodyProfessionalExperiencesItemAttachmentsMax).optional()
})).optional(),
  "educationCertifications": zod.array(zod.object({
  "title": zod.string().min(1),
  "description": zod.string().optional(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createEmployeeBodyEducationCertificationsItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createEmployeeBodyEducationCertificationsItemAttachmentsItemObjectPathRegExp)
})).max(createEmployeeBodyEducationCertificationsItemAttachmentsMax).optional()
})).optional(),
...
export const ListOrganizationTrainingsQueryParams = zod.object({
  ...
  "effectivenessStatus": zod.enum(['pending', 'effective', 'ineffective']).optional(),
  "page": zod.coerce.number().min(1).optional(),
  "pageSize": zod.coerce.number().min(1).max(listOrganizationTrainingsQueryPageSizeMax).optional()
})

export const listOrganizationTrainingsResponseDataItemAttachmentsItemFileSizeMax = 20971520;

export const listOrganizationTrainingsResponseDataItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListOrganizationTrainingsResponse = zod.object({
  ...
  "targetCompetencyType": zod.enum(['formacao', 'experiencia', 'habilidade']).nullish(),
  ...
  "effectivenessStatus": zod.enum(['pending', 'effective', 'ineffective']).nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listOrganizationTrainingsResponseDataItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listOrganizationTrainingsResponseDataItemAttachmentsItemObjectPathRegExp)
})),
  "latestEffectivenessReview": zod.object({
  "id": zod.number(),
  "trainingId": zod.number(),
  "evaluatorUserId": zod.number(),
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneScoreMin).max(listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneResultLevelMin).max(listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listOrganizationTrainingsResponseDataItemLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp)
})),
...
export const ListEmployeeCompetencyGapsQueryParams = zod.object({
  ...
  "page": zod.coerce.number().min(1).optional(),
  "pageSize": zod.coerce.number().min(1).max(listEmployeeCompetencyGapsQueryPageSizeMax).optional()
})
...
export const ListPositionCompetencyRequirementsResponseItem = zod.object({
  ...
  "competencyName": zod.string(),
  "competencyType": zod.enum(['formacao', 'experiencia', 'habilidade']),
  "requiredLevel": zod.number().min(listPositionCompetencyRequirementsResponseRequiredLevelMin).max(listPositionCompetencyRequirementsResponseRequiredLevelMax),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(listPositionCompetencyRequirementsResponseSortOrderMin),
  "createdById": zod.number(),
  "updatedById": zod.number(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})
export const ListPositionCompetencyRequirementsResponse = zod.array(ListPositionCompetencyRequirementsResponseItem)
...
export const CreatePositionCompetencyRequirementBody = zod.object({
  ...
  "competencyType": zod.enum(['formacao', 'experiencia', 'habilidade']),
  "requiredLevel": zod.number().min(createPositionCompetencyRequirementBodyRequiredLevelMin).max(createPositionCompetencyRequirementBodyRequiredLevelMax),
  "notes": zod.string().optional(),
  "sortOrder": zod.number().min(createPositionCompetencyRequirementBodySortOrderMin).optional()
})
...
export const UpdatePositionCompetencyRequirementBody = zod.object({
  ...
  "competencyType": zod.enum(['formacao', 'experiencia', 'habilidade']).optional(),
  "requiredLevel": zod.number().min(updatePositionCompetencyRequirementBodyRequiredLevelMin).max(updatePositionCompetencyRequirementBodyRequiredLevelMax).optional(),
  "notes": zod.string().optional(),
  "sortOrder": zod.number().min(updatePositionCompetencyRequirementBodySortOrderMin).optional()
})
...
export const UpdatePositionCompetencyRequirementResponse = zod.object({
  ...
  "competencyName": zod.string(),
  "competencyType": zod.enum(['formacao', 'experiencia', 'habilidade']),
  "requiredLevel": zod.number().min(updatePositionCompetencyRequirementResponseRequiredLevelMin).max(updatePositionCompetencyRequirementResponseRequiredLevelMax),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(updatePositionCompetencyRequirementResponseSortOrderMin),
  "createdById": zod.number(),
  "updatedById": zod.number(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
...
export const ListPositionCompetencyMatrixRevisionsResponseItem = zod.object({
  ...
  "competencyName": zod.string(),
  "competencyType": zod.enum(['formacao', 'experiencia', 'habilidade']),
  "requiredLevel": zod.number().min(listPositionCompetencyMatrixRevisionsResponseSnapshotItemRequiredLevelMin).max(listPositionCompetencyMatrixRevisionsResponseSnapshotItemRequiredLevelMax),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(listPositionCompetencyMatrixRevisionsResponseSnapshotItemSortOrderMin),
  "createdById": zod.number(),
  "updatedById": zod.number(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
...
export const ListPositionCompetencyMatrixRevisionsResponse = zod.array(ListPositionCompetencyMatrixRevisionsResponseItem)
...
export const getEmployeeResponseTwoCompetenciesItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const getEmployeeResponseTwoTrainingsItemAttachmentsItemFileSizeMax = 20971520;

export const getEmployeeResponseTwoTrainingsItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const getEmployeeResponseTwoAwarenessItemAttachmentsItemFileSizeMax = 20971520;

export const getEmployeeResponseTwoAwarenessItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const GetEmployeeResponse = zod.object({
  ...
  "requiredLevel": zod.number().min(getEmployeeResponseTwoCompetenciesItemRequiredLevelMin).max(getEmployeeResponseTwoCompetenciesItemRequiredLevelMax),
  "acquiredLevel": zod.number().min(getEmployeeResponseTwoCompetenciesItemAcquiredLevelMin).max(getEmployeeResponseTwoCompetenciesItemAcquiredLevelMax),
  "evidence": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getEmployeeResponseTwoCompetenciesItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getEmployeeResponseTwoCompetenciesItemAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})).optional(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getEmployeeResponseTwoTrainingsItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getEmployeeResponseTwoTrainingsItemAttachmentsItemObjectPathRegExp)
})),
  "latestEffectivenessReview": zod.object({
  "id": zod.number(),
  "trainingId": zod.number(),
  ...
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneScoreMin).max(getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneResultLevelMin).max(getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getEmployeeResponseTwoTrainingsItemLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
}).nullish(),
  "effectivenessReviews": zod.array(zod.object({
  "id": zod.number(),
  "trainingId": zod.number(),
  "evaluatorUserId": zod.number(),
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemScoreMin).max(getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemResultLevelMin).max(getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getEmployeeResponseTwoTrainingsItemEffectivenessReviewsItemAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
})),
  "createdAt": zod.string().datetime({}).optional(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getEmployeeResponseTwoAwarenessItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getEmployeeResponseTwoAwarenessItemAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})).optional(),
...
export const listCompetenciesResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListCompetenciesResponseItem = zod.object({
  ...
  "description": zod.string().nullish(),
  "type": zod.enum(['formacao', 'experiencia', 'habilidade']),
  "requiredLevel": zod.number().min(listCompetenciesResponseRequiredLevelMin).max(listCompetenciesResponseRequiredLevelMax),
  "acquiredLevel": zod.number().min(listCompetenciesResponseAcquiredLevelMin).max(listCompetenciesResponseAcquiredLevelMax),
  "evidence": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listCompetenciesResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listCompetenciesResponseAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})
...
export const createCompetencyBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateCompetencyBody = zod.object({
  ...
  "requiredLevel": zod.number().min(createCompetencyBodyRequiredLevelMin).max(createCompetencyBodyRequiredLevelMax).optional(),
  "acquiredLevel": zod.number().min(createCompetencyBodyAcquiredLevelMin).max(createCompetencyBodyAcquiredLevelMax).optional(),
  "evidence": zod.string().optional(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createCompetencyBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createCompetencyBodyAttachmentsItemObjectPathRegExp)
})).max(createCompetencyBodyAttachmentsMax).optional()
})
...
export const updateCompetencyBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateCompetencyBody = zod.object({
  ...
  "description": zod.string().optional(),
  "type": zod.enum(['formacao', 'experiencia', 'habilidade']).optional(),
  "requiredLevel": zod.number().min(updateCompetencyBodyRequiredLevelMin).max(updateCompetencyBodyRequiredLevelMax).optional(),
  "acquiredLevel": zod.number().min(updateCompetencyBodyAcquiredLevelMin).max(updateCompetencyBodyAcquiredLevelMax).optional(),
  "evidence": zod.string().optional(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateCompetencyBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateCompetencyBodyAttachmentsItemObjectPathRegExp)
})).max(updateCompetencyBodyAttachmentsMax).optional()
})
...
export const updateCompetencyResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateCompetencyResponse = zod.object({
  ...
  "description": zod.string().nullish(),
  "type": zod.enum(['formacao', 'experiencia', 'habilidade']),
  "requiredLevel": zod.number().min(updateCompetencyResponseRequiredLevelMin).max(updateCompetencyResponseRequiredLevelMax),
  "acquiredLevel": zod.number().min(updateCompetencyResponseAcquiredLevelMin).max(updateCompetencyResponseAcquiredLevelMax),
  "evidence": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateCompetencyResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateCompetencyResponseAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})
...
export const listTrainingsResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const listTrainingsResponseLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const listTrainingsResponseEffectivenessReviewsItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListTrainingsResponseItem = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listTrainingsResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listTrainingsResponseAttachmentsItemObjectPathRegExp)
})),
  "latestEffectivenessReview": zod.object({
  "id": zod.number(),
  "trainingId": zod.number(),
  ...
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(listTrainingsResponseLatestEffectivenessReviewOneScoreMin).max(listTrainingsResponseLatestEffectivenessReviewOneScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(listTrainingsResponseLatestEffectivenessReviewOneResultLevelMin).max(listTrainingsResponseLatestEffectivenessReviewOneResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listTrainingsResponseLatestEffectivenessReviewOneAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listTrainingsResponseLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
}).nullish(),
  "effectivenessReviews": zod.array(zod.object({
  ...
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(listTrainingsResponseEffectivenessReviewsItemScoreMin).max(listTrainingsResponseEffectivenessReviewsItemScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(listTrainingsResponseEffectivenessReviewsItemResultLevelMin).max(listTrainingsResponseEffectivenessReviewsItemResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listTrainingsResponseEffectivenessReviewsItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listTrainingsResponseEffectivenessReviewsItemAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
})),
  "createdAt": zod.string().datetime({}).optional(),
...
export const createTrainingBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateTrainingBody = zod.object({
  ...
  "targetCompetencyType": zod.enum(['formacao', 'experiencia', 'habilidade']).optional(),
  "targetCompetencyLevel": zod.number().min(createTrainingBodyTargetCompetencyLevelMin).max(createTrainingBodyTargetCompetencyLevelMax).optional(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createTrainingBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createTrainingBodyAttachmentsItemObjectPathRegExp)
})).max(createTrainingBodyAttachmentsMax).optional()
})
...
export const updateTrainingBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateTrainingBody = zod.object({
  ...
  "targetCompetencyName": zod.string().optional(),
  "targetCompetencyType": zod.enum(['formacao', 'experiencia', 'habilidade']).optional(),
  "targetCompetencyLevel": zod.number().min(updateTrainingBodyTargetCompetencyLevelMin).max(updateTrainingBodyTargetCompetencyLevelMax).optional(),
  "evaluationMethod": zod.string().optional(),
  "renewalMonths": zod.number().min(1).optional(),
  "workloadHours": zod.number().optional(),
  "completionDate": zod.string().optional(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateTrainingBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateTrainingBodyAttachmentsItemObjectPathRegExp)
})).max(updateTrainingBodyAttachmentsMax).optional()
})

export const updateTrainingResponseAttachmentsItemFileSizeMax = 20971520;

export const updateTrainingResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const updateTrainingResponseLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const updateTrainingResponseEffectivenessReviewsItemAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateTrainingResponse = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateTrainingResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateTrainingResponseAttachmentsItemObjectPathRegExp)
})),
  "latestEffectivenessReview": zod.object({
  "id": zod.number(),
  "trainingId": zod.number(),
  ...
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(updateTrainingResponseLatestEffectivenessReviewOneScoreMin).max(updateTrainingResponseLatestEffectivenessReviewOneScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(updateTrainingResponseLatestEffectivenessReviewOneResultLevelMin).max(updateTrainingResponseLatestEffectivenessReviewOneResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateTrainingResponseLatestEffectivenessReviewOneAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateTrainingResponseLatestEffectivenessReviewOneAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
}).nullish(),
  "effectivenessReviews": zod.array(zod.object({
  ...
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(updateTrainingResponseEffectivenessReviewsItemScoreMin).max(updateTrainingResponseEffectivenessReviewsItemScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(updateTrainingResponseEffectivenessReviewsItemResultLevelMin).max(updateTrainingResponseEffectivenessReviewsItemResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateTrainingResponseEffectivenessReviewsItemAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateTrainingResponseEffectivenessReviewsItemAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
})),
  "createdAt": zod.string().datetime({}).optional(),
...
export const listTrainingEffectivenessReviewsResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListTrainingEffectivenessReviewsResponseItem = zod.object({
  ...
  "evaluatorName": zod.string().nullish(),
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(listTrainingEffectivenessReviewsResponseScoreMin).max(listTrainingEffectivenessReviewsResponseScoreMax).nullish(),
  "isEffective": zod.boolean().nullish(),
  "resultLevel": zod.number().min(listTrainingEffectivenessReviewsResponseResultLevelMin).max(listTrainingEffectivenessReviewsResponseResultLevelMax).nullish(),
  "comments": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listTrainingEffectivenessReviewsResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listTrainingEffectivenessReviewsResponseAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional()
})
export const ListTrainingEffectivenessReviewsResponse = zod.array(ListTrainingEffectivenessReviewsResponseItem)
...
export const createTrainingEffectivenessReviewBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateTrainingEffectivenessReviewBody = zod.object({
  "evaluationDate": zod.string().date(),
  "score": zod.number().min(createTrainingEffectivenessReviewBodyScoreMin).max(createTrainingEffectivenessReviewBodyScoreMax).optional(),
  "isEffective": zod.boolean(),
  "resultLevel": zod.number().min(createTrainingEffectivenessReviewBodyResultLevelMin).max(createTrainingEffectivenessReviewBodyResultLevelMax).optional(),
  "comments": zod.string().optional(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createTrainingEffectivenessReviewBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createTrainingEffectivenessReviewBodyAttachmentsItemObjectPathRegExp)
})).max(createTrainingEffectivenessReviewBodyAttachmentsMax).optional()
})
...
export const listAwarenessResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListAwarenessResponseItem = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listAwarenessResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listAwarenessResponseAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})
...
export const createAwarenessBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateAwarenessBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createAwarenessBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createAwarenessBodyAttachmentsItemObjectPathRegExp)
})).max(createAwarenessBodyAttachmentsMax).optional()
})
...
export const updateAwarenessBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateAwarenessBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateAwarenessBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateAwarenessBodyAttachmentsItemObjectPathRegExp)
})).max(updateAwarenessBodyAttachmentsMax).optional()
})

export const updateAwarenessResponseAttachmentsItemFileSizeMax = 20971520;

export const updateAwarenessResponseAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateAwarenessResponse = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateAwarenessResponseAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateAwarenessResponseAttachmentsItemObjectPathRegExp)
})),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
})
...
export const createEmployeeProfileItemBodyAttachmentsItemObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateEmployeeProfileItemBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createEmployeeProfileItemBodyAttachmentsItemFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createEmployeeProfileItemBodyAttachmentsItemObjectPathRegExp)
})).max(createEmployeeProfileItemBodyAttachmentsMax).optional()
})
...
export const addEmployeeProfileItemAttachmentBodyObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const AddEmployeeProfileItemAttachmentBody = zod.object({
  ...
  "contentType": zod.string(),
  "objectPath": zod.string().regex(addEmployeeProfileItemAttachmentBodyObjectPathRegExp)
})
...
export const ImportPositionsBody = zod.object({
  ...
  "conflictStrategy": zod.enum(['skip', 'update']).optional().describe('How to handle positions that already exist (matched by name)')
})
...
export const ListDocumentsQueryParams = zod.object({
  ...
  "unitId": zod.coerce.number().optional(),
  "page": zod.coerce.number().min(1).optional(),
  "pageSize": zod.coerce.number().min(1).max(listDocumentsQueryPageSizeMax).optional()
})
...
export const ListDocumentsResponseItem = zod.object({
  ...
  "type": zod.string(),
  "status": zod.string(),
  "currentVersion": zod.number().describe('0 indicates the document has no approved formal version yet.'),
...
export const CreateDocumentBody = zod.object({
  "title": zod.string(),
  "type": zod.enum(['manual', 'procedimento', 'instrucao', 'formulario', 'registro', 'politica', 'outro']),
...
export const ListOrganizationContactsResponseItem = zod.object({
  ...
  "classificationType": zod.enum(['supplier', 'customer', 'partner', 'auditor', 'consultant', 'other']),
...
export const ListOrganizationContactsResponse = zod.array(ListOrganizationContactsResponseItem)
...
export const CreateOrganizationContactBody = zod.union([zod.object({
  "sourceType": zod.enum(['system_user']),
  "sourceId": zod.number(),
  "phone": zod.string().nullish(),
  "organizationName": zod.string().nullish(),
  "classificationType": zod.enum(['supplier', 'customer', 'partner', 'auditor', 'consultant', 'other']).optional(),
  "classificationDescription": zod.string().nullish(),
  "notes": zod.string().nullish()
}),zod.object({
...
export const UpdateOrganizationContactBody = zod.union([zod.object({
  "sourceType": zod.enum(['system_user']),
  "sourceId": zod.number(),
  "name": zod.string().optional(),
  "email": zod.string().email().optional(),
...
export const ListOrganizationContactGroupsResponse = zod.array(ListOrganizationContactGroupsResponseItem)
...
export const GetDocumentResponse = zod.object({
  ...
  "elaborators": zod.array(zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "unitId": zod.number().nullish(),
  "name": zod.string(),
  ...
  "criticalReviewers": zod.array(zod.object({
  "id": zod.number().optional(),
  ...
  "directRecipients": zod.array(zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "name": zod.string(),
  "email": zod.string().email()
})).optional(),
  "recipientGroups": zod.array(zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "description": zod.string().nullish(),
  "memberCount": zod.number(),
  ...
  "groupContacts": zod.array(zod.object({
  "id": zod.number(),
  "sourceType": zod.enum(['system_user', 'employee', 'external_contact']),
  "sourceId": zod.number().nullish(),
  "name": zod.string(),
  ...
  "communicationPlans": zod.array(zod.object({
  "id": zod.number(),
  "channel": zod.string(),
  "audience": zod.string(),
...
export const ListDocumentCommunicationPlansResponse = zod.array(ListDocumentCommunicationPlansResponseItem)
...
export const UpdateDocumentCommunicationPlanResponse = zod.array(UpdateDocumentCommunicationPlanResponseItem)
...
export const ListUserOptionsQueryParams = zod.object({
  "search": zod.coerce.string().optional(),
  "page": zod.coerce.number().min(1).optional(),
  "pageSize": zod.coerce.number().min(1).max(listUserOptionsQueryPageSizeMax).optional()
})
...
export const UpdateUserModulesResponse = zod.object({
  ...
  "modules": zod.array(zod.enum(['documents', 'legislations', 'employees', 'units', 'departments', 'positions', 'governance', 'suppliers', 'environmental'])).optional()
})
...
export const ListStrategicPlansResponseItem = zod.object({
  ...
  "organizationId": zod.number(),
  "title": zod.string(),
  "status": zod.enum(['draft', 'in_review', 'approved', 'rejected', 'overdue', 'archived']),
  ...
  "openActionsByUnit": zod.array(zod.object({
  "unitId": zod.number(),
  "unitName": zod.string(),
...
export const ListStrategicPlansResponse = zod.array(ListStrategicPlansResponseItem)
...
export const CreateStrategicPlanBody = zod.object({
  ...
  "executiveSummary": zod.string().nullish(),
  "reviewFrequencyMonths": zod.number().min(1).max(createStrategicPlanBodyReviewFrequencyMonthsMax).optional(),
  ...
  "legacyRevisionHistory": zod.array(zod.object({
...
export const ListGovernanceRiskOpportunityItemsQueryParams = zod.object({
  ...
  "status": zod.enum(['identified', 'assessed', 'responding', 'awaiting_effectiveness', 'effective', 'ineffective', 'continuous', 'canceled']).optional(),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).optional(),
  "ownerUserId": zod.coerce.number().optional(),
  "unitId": zod.coerce.number().optional(),
  "sourceType": zod.enum(['swot', 'audit', 'meeting', 'legislation', 'incident', 'internal_strategy', 'other']).optional()
})
...
export const ListGovernanceRiskOpportunityItemsResponseItem = zod.object({
  "id": zod.number(),
  "planId": zod.number(),
  "type": zod.enum(['risk', 'opportunity']),
  "sourceType": zod.enum(['swot', 'audit', 'meeting', 'legislation', 'incident', 'internal_strategy', 'other']),
  ...
  "likelihood": zod.number().min(1).max(listGovernanceRiskOpportunityItemsResponseOneLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(listGovernanceRiskOpportunityItemsResponseOneImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
  "status": zod.enum(['identified', 'assessed', 'responding', 'awaiting_effectiveness', 'effective', 'ineffective', 'continuous', 'canceled']),
...
export const ListGovernanceRiskOpportunityItemsResponse = zod.array(ListGovernanceRiskOpportunityItemsResponseItem)
...
export const GetStrategicPlanResponse = zod.object({
  ...
  "archivedAt": zod.string().nullish(),
  "swotItems": zod.array(zod.object({
  "id": zod.number(),
  "planId": zod.number(),
  ...
  "interestedParties": zod.array(zod.object({
  "id": zod.number(),
  "planId": zod.number(),
  "name": zod.string(),
  ...
  "riskOpportunityItems": zod.array(zod.object({
  "id": zod.number(),
  "planId": zod.number(),
  "type": zod.enum(['risk', 'opportunity']),
  "sourceType": zod.enum(['swot', 'audit', 'meeting', 'legislation', 'incident', 'internal_strategy', 'other']),
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(getStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(getStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const UpdateStrategicPlanBody = zod.object({
  ...
  "standards": zod.array(zod.string()).optional(),
  "executiveSummary": zod.string().nullish(),
  "reviewFrequencyMonths": zod.number().min(1).max(updateStrategicPlanBodyReviewFrequencyMonthsMax).optional(),
  "nextReviewAt": zod.string().datetime({}).nullish(),
  "reviewReason": zod.string().nullish(),
  "climateChangeRelevant": zod.boolean().nullish(),
  "climateChangeJustification": zod.string().nullish(),
...
export const UpdateStrategicPlanResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(updateStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(updateStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ImportStrategicPlanBody = zod.object({
  ...
  "standards": zod.array(zod.string()).optional(),
  "executiveSummary": zod.string().nullish(),
  "reviewFrequencyMonths": zod.number().min(1).max(importStrategicPlanBodyPlanReviewFrequencyMonthsMax).optional(),
  "nextReviewAt": zod.string().datetime({}).nullish(),
  "reviewReason": zod.string().nullish(),
  "climateChangeRelevant": zod.boolean().nullish(),
  "climateChangeJustification": zod.string().nullish(),
  ...
  "performance": zod.number().min(importStrategicPlanBodySwotItemsItemOnePerformanceMin).max(importStrategicPlanBodySwotItemsItemOnePerformanceMax).nullish(),
  "relevance": zod.number().min(importStrategicPlanBodySwotItemsItemOneRelevanceMin).max(importStrategicPlanBodySwotItemsItemOneRelevanceMax).nullish(),
  "result": zod.number().min(importStrategicPlanBodySwotItemsItemOneResultMin).max(importStrategicPlanBodySwotItemsItemOneResultMax).nullish(),
  "treatmentDecision": zod.string().nullish(),
  "linkedObjectiveCode": zod.string().nullish(),
  "linkedObjectiveLabel": zod.string().nullish(),
  "importedActionReference": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(importStrategicPlanBodySwotItemsItemOneSortOrderMin).optional()
}).and(zod.object({
  ...
  "monitoringMethod": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(importStrategicPlanBodyInterestedPartiesItemSortOrderMin).optional()
})),
  "objectives": zod.array(zod.object({
  ...
  "description": zod.string().min(1),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(importStrategicPlanBodyObjectivesItemOneSortOrderMin).optional()
}).and(zod.object({
  "importKey": zod.string().nullish()
}))),
  "actions": zod.array(zod.object({
  ...
  "notes": zod.string().nullish(),
  "unitIds": zod.array(zod.number()).optional(),
  "sortOrder": zod.number().min(importStrategicPlanBodyActionsItemSortOrderMin).optional()
}))
})
...
export const ImportStrategicPlanResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(importStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(importStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const SubmitStrategicPlanResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(submitStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(submitStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const AcknowledgeStrategicPlanReviewReadResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(acknowledgeStrategicPlanReviewReadResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(acknowledgeStrategicPlanReviewReadResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ApproveStrategicPlanResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(approveStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(approveStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const RejectStrategicPlanResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(rejectStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(rejectStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ReopenStrategicPlanResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(reopenStrategicPlanResponseRiskOpportunityItemsItemLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(reopenStrategicPlanResponseRiskOpportunityItemsItemImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ListStrategicPlanSwotItemsResponse = zod.array(ListStrategicPlanSwotItemsResponseItem)
...
export const CreateStrategicPlanSwotItemBody = zod.object({
  ...
  "perspective": zod.string().nullish(),
  "description": zod.string().min(1),
  "performance": zod.number().min(createStrategicPlanSwotItemBodyPerformanceMin).max(createStrategicPlanSwotItemBodyPerformanceMax).nullish(),
  "relevance": zod.number().min(createStrategicPlanSwotItemBodyRelevanceMin).max(createStrategicPlanSwotItemBodyRelevanceMax).nullish(),
  "result": zod.number().min(createStrategicPlanSwotItemBodyResultMin).max(createStrategicPlanSwotItemBodyResultMax).nullish(),
  "treatmentDecision": zod.string().nullish(),
  "linkedObjectiveCode": zod.string().nullish(),
  "linkedObjectiveLabel": zod.string().nullish(),
  "importedActionReference": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(createStrategicPlanSwotItemBodySortOrderMin).optional()
})
...
export const UpdateStrategicPlanSwotItemBody = zod.object({
  ...
  "perspective": zod.string().nullish(),
  "description": zod.string().min(1),
  "performance": zod.number().min(updateStrategicPlanSwotItemBodyOnePerformanceMin).max(updateStrategicPlanSwotItemBodyOnePerformanceMax).nullish(),
  "relevance": zod.number().min(updateStrategicPlanSwotItemBodyOneRelevanceMin).max(updateStrategicPlanSwotItemBodyOneRelevanceMax).nullish(),
  "result": zod.number().min(updateStrategicPlanSwotItemBodyOneResultMin).max(updateStrategicPlanSwotItemBodyOneResultMax).nullish(),
  "treatmentDecision": zod.string().nullish(),
  "linkedObjectiveCode": zod.string().nullish(),
  "linkedObjectiveLabel": zod.string().nullish(),
  "importedActionReference": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(updateStrategicPlanSwotItemBodyOneSortOrderMin).optional()
})
...
export const ListStrategicPlanInterestedPartiesResponse = zod.array(ListStrategicPlanInterestedPartiesResponseItem)
...
export const CreateStrategicPlanInterestedPartyBody = zod.object({
  ...
  "monitoringMethod": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(createStrategicPlanInterestedPartyBodySortOrderMin).optional()
})
...
export const UpdateStrategicPlanInterestedPartyBody = zod.object({
  ...
  "monitoringMethod": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(updateStrategicPlanInterestedPartyBodyOneSortOrderMin).optional()
})
...
export const ListStrategicPlanObjectivesResponse = zod.array(ListStrategicPlanObjectivesResponseItem)
...
export const CreateStrategicPlanObjectiveBody = zod.object({
  ...
  "description": zod.string().min(1),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(createStrategicPlanObjectiveBodySortOrderMin).optional()
})
...
export const UpdateStrategicPlanObjectiveBody = zod.object({
  ...
  "description": zod.string().min(1),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(updateStrategicPlanObjectiveBodyOneSortOrderMin).optional()
})
...
export const ListStrategicPlanActionsResponse = zod.array(ListStrategicPlanActionsResponseItem)
...
export const CreateStrategicPlanActionBody = zod.object({
  ...
  "notes": zod.string().nullish(),
  "unitIds": zod.array(zod.number()).optional(),
  "sortOrder": zod.number().min(createStrategicPlanActionBodySortOrderMin).optional()
})
...
export const UpdateStrategicPlanActionBody = zod.object({
  ...
  "notes": zod.string().nullish(),
  "unitIds": zod.array(zod.number()).optional(),
  "sortOrder": zod.number().min(updateStrategicPlanActionBodyOneSortOrderMin).optional()
})
...
export const ListStrategicPlanRiskOpportunityItemsResponseItem = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(listStrategicPlanRiskOpportunityItemsResponseLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(listStrategicPlanRiskOpportunityItemsResponseImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ListStrategicPlanRiskOpportunityItemsResponse = zod.array(ListStrategicPlanRiskOpportunityItemsResponseItem)
...
export const CreateStrategicPlanRiskOpportunityItemBody = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(createStrategicPlanRiskOpportunityItemBodyLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(createStrategicPlanRiskOpportunityItemBodyImpactMax).nullish(),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().datetime({}).nullish(),
  "status": zod.enum(['identified', 'assessed', 'responding', 'awaiting_effectiveness', 'effective', 'ineffective', 'continuous', 'canceled']).optional(),
  "existingControls": zod.string().nullish(),
  "expectedEffect": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(createStrategicPlanRiskOpportunityItemBodySortOrderMin).optional()
})
...
export const UpdateStrategicPlanRiskOpportunityItemBody = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(updateStrategicPlanRiskOpportunityItemBodyOneLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(updateStrategicPlanRiskOpportunityItemBodyOneImpactMax).nullish(),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().datetime({}).nullish(),
  "status": zod.enum(['identified', 'assessed', 'responding', 'awaiting_effectiveness', 'effective', 'ineffective', 'continuous', 'canceled']).optional(),
  "existingControls": zod.string().nullish(),
  "expectedEffect": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number().min(updateStrategicPlanRiskOpportunityItemBodyOneSortOrderMin).optional()
})
...
export const UpdateStrategicPlanRiskOpportunityItemResponse = zod.object({
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(updateStrategicPlanRiskOpportunityItemResponseLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(updateStrategicPlanRiskOpportunityItemResponseImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ListKnowledgeAssetsQueryParams = zod.object({
  "page": zod.coerce.number().min(1).optional(),
  "pageSize": zod.coerce.number().min(1).max(listKnowledgeAssetsQueryPageSizeMax).optional(),
  "search": zod.coerce.string().optional(),
...
export const listKnowledgeAssetsResponseDataItemEvidenceAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListKnowledgeAssetsResponse = zod.object({
  ...
  "evidenceAttachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listKnowledgeAssetsResponseDataItemEvidenceAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listKnowledgeAssetsResponseDataItemEvidenceAttachmentsItemOneObjectPathRegExp)
})),
...
export const createKnowledgeAssetBodyEvidenceAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateKnowledgeAssetBody = zod.object({
  ...
  "evidenceAttachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createKnowledgeAssetBodyEvidenceAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createKnowledgeAssetBodyEvidenceAttachmentsItemOneObjectPathRegExp)
})).optional(),
  "evidenceValidUntil": zod.string().date().nullish(),
  "links": zod.array(zod.union([zod.object({
...
export const getKnowledgeAssetResponseOneEvidenceAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const GetKnowledgeAssetResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  ...
  "evidenceAttachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getKnowledgeAssetResponseOneEvidenceAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getKnowledgeAssetResponseOneEvidenceAttachmentsItemOneObjectPathRegExp)
})),
  "evidenceValidUntil": zod.string().date().nullish(),
  "evidenceStatus": zod.enum(['missing', 'expired', 'valid']),
  "links": zod.array(zod.object({
...
export const updateKnowledgeAssetBodyEvidenceAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateKnowledgeAssetBody = zod.object({
  ...
  "evidenceAttachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateKnowledgeAssetBodyEvidenceAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateKnowledgeAssetBodyEvidenceAttachmentsItemOneObjectPathRegExp)
})).optional(),
  "evidenceValidUntil": zod.string().date().nullish(),
  "links": zod.array(zod.union([zod.object({
  "processId": zod.number()
...
export const updateKnowledgeAssetResponseOneEvidenceAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateKnowledgeAssetResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  ...
  "evidenceAttachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateKnowledgeAssetResponseOneEvidenceAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateKnowledgeAssetResponseOneEvidenceAttachmentsItemOneObjectPathRegExp)
})),
  "evidenceValidUntil": zod.string().date().nullish(),
  "evidenceStatus": zod.enum(['missing', 'expired', 'valid']),
  "links": zod.array(zod.object({
...
export const createSgqProcessBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateSgqProcessBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createSgqProcessBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createSgqProcessBodyAttachmentsItemOneObjectPathRegExp)
})).optional(),
  "changeSummary": zod.string().nullish(),
...
export const getSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const getSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax = 20971520;

export const getSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const GetSgqProcessResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "name": zod.string(),
  "objective": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getSgqProcessResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp)
})),
  "interactions": zod.array(zod.object({
  "relatedProcessId": zod.number(),
  "direction": zod.enum(['upstream', 'downstream']),
...
export const updateSgqProcessBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateSgqProcessBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateSgqProcessBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateSgqProcessBodyAttachmentsItemOneObjectPathRegExp)
})).optional(),
  "status": zod.enum(['active', 'inactive']).optional(),
  "changeSummary": zod.string().nullish(),
  "interactions": zod.array(zod.object({
...
export const updateSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const updateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax = 20971520;

export const updateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateSgqProcessResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "name": zod.string(),
  "objective": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateSgqProcessResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "createdById": zod.number().nullish(),
  "updatedById": zod.number().nullish(),
  "interactions": zod.array(zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp)
})),
  "interactions": zod.array(zod.object({
  "relatedProcessId": zod.number(),
  "direction": zod.enum(['upstream', 'downstream']),
...
export const inactivateSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const inactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax = 20971520;

export const inactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const InactivateSgqProcessResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "name": zod.string(),
  "objective": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(inactivateSgqProcessResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(inactivateSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "createdById": zod.number().nullish(),
  "updatedById": zod.number().nullish(),
  "interactions": zod.array(zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(inactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(inactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp)
})),
  "interactions": zod.array(zod.object({
  "relatedProcessId": zod.number(),
  "direction": zod.enum(['upstream', 'downstream']),
...
export const reactivateSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const reactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax = 20971520;

export const reactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const ReactivateSgqProcessResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "name": zod.string(),
  "objective": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(reactivateSgqProcessResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(reactivateSgqProcessResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "createdById": zod.number().nullish(),
  "updatedById": zod.number().nullish(),
  "interactions": zod.array(zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(reactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(reactivateSgqProcessResponseTwoRevisionsItemSnapshotAttachmentsItemOneObjectPathRegExp)
})),
  "interactions": zod.array(zod.object({
  "relatedProcessId": zod.number(),
  "direction": zod.enum(['upstream', 'downstream']),
...
export const listSgqProcessRevisionsResponseSnapshotAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListSgqProcessRevisionsResponseItem = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listSgqProcessRevisionsResponseSnapshotAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listSgqProcessRevisionsResponseSnapshotAttachmentsItemOneObjectPathRegExp)
})),
  "interactions": zod.array(zod.object({
  "relatedProcessId": zod.number(),
  "direction": zod.enum(['upstream', 'downstream']),
...
export const ListSgqProcessRevisionsResponse = zod.array(ListSgqProcessRevisionsResponseItem)
...
export const ListInternalAuditsQueryParams = zod.object({
  "page": zod.coerce.number().optional(),
  "pageSize": zod.coerce.number().optional(),
  "status": zod.enum(['planned', 'in_progress', 'completed', 'canceled']).optional(),
...
export const createInternalAuditBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateInternalAuditBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createInternalAuditBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createInternalAuditBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})
...
export const getInternalAuditResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const getInternalAuditResponseTwoFindingsItemAttachmentsItemOneFileSizeMax = 20971520;

export const getInternalAuditResponseTwoFindingsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const GetInternalAuditResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "scope": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getInternalAuditResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getInternalAuditResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  ...
  "result": zod.enum(['conformity', 'nonconformity', 'observation', 'not_evaluated']),
  "notes": zod.string().nullish(),
  "sortOrder": zod.number(),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getInternalAuditResponseTwoFindingsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getInternalAuditResponseTwoFindingsItemAttachmentsItemOneObjectPathRegExp)
})),
...
export const updateInternalAuditBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateInternalAuditBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateInternalAuditBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateInternalAuditBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})

export const updateInternalAuditResponseTwoAttachmentsItemOneFileSizeMax = 20971520;

export const updateInternalAuditResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const updateInternalAuditResponseTwoFindingsItemAttachmentsItemOneFileSizeMax = 20971520;

export const updateInternalAuditResponseTwoFindingsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateInternalAuditResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "scope": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateInternalAuditResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateInternalAuditResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "checklistItems": zod.array(zod.object({
  "id": zod.number(),
  "auditId": zod.number(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateInternalAuditResponseTwoFindingsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateInternalAuditResponseTwoFindingsItemAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActionId": zod.number().nullish(),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
...
export const SyncInternalAuditChecklistItemsBody = zod.object({
  ...
  "label": zod.string(),
  "requirementRef": zod.string().nullish(),
  "result": zod.enum(['conformity', 'nonconformity', 'observation', 'not_evaluated']).optional(),
  "notes": zod.string().nullish(),
...
export const syncInternalAuditChecklistItemsResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const syncInternalAuditChecklistItemsResponseTwoFindingsItemAttachmentsItemOneFileSizeMax = 20971520;

export const syncInternalAuditChecklistItemsResponseTwoFindingsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const SyncInternalAuditChecklistItemsResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "scope": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(syncInternalAuditChecklistItemsResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(syncInternalAuditChecklistItemsResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "checklistItems": zod.array(zod.object({
  "id": zod.number(),
  "auditId": zod.number(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(syncInternalAuditChecklistItemsResponseTwoFindingsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(syncInternalAuditChecklistItemsResponseTwoFindingsItemAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActionId": zod.number().nullish(),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
...
export const listInternalAuditFindingsResponseAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListInternalAuditFindingsResponseItem = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listInternalAuditFindingsResponseAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listInternalAuditFindingsResponseAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActionId": zod.number().nullish(),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
})
export const ListInternalAuditFindingsResponse = zod.array(ListInternalAuditFindingsResponseItem)
...
export const createInternalAuditFindingBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateInternalAuditFindingBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createInternalAuditFindingBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createInternalAuditFindingBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})
...
export const updateInternalAuditFindingBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateInternalAuditFindingBody = zod.object({
  "processId": zod.number().nullish(),
  "requirementRef": zod.string().nullish(),
  "classification": zod.enum(['conformity', 'observation', 'nonconformity']).optional(),
  "description": zod.string().optional(),
  "responsibleUserId": zod.number().nullish(),
  "dueDate": zod.string().nullish(),
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateInternalAuditFindingBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateInternalAuditFindingBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})

export const updateInternalAuditFindingResponseAttachmentsItemOneFileSizeMax = 20971520;

export const updateInternalAuditFindingResponseAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateInternalAuditFindingResponse = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateInternalAuditFindingResponseAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateInternalAuditFindingResponseAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActionId": zod.number().nullish(),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
...
export const ListNonconformitiesQueryParams = zod.object({
  "page": zod.coerce.number().optional(),
  "pageSize": zod.coerce.number().optional(),
  "status": zod.enum(['open', 'under_analysis', 'action_in_progress', 'awaiting_effectiveness', 'closed', 'canceled']).optional(),
  "originType": zod.enum(['audit_finding', 'incident', 'document', 'process', 'risk', 'other']).optional(),
...
export const ListNonconformitiesResponse = zod.object({
  ...
  "id": zod.number(),
  "organizationId": zod.number(),
  "originType": zod.enum(['audit_finding', 'incident', 'document', 'process', 'risk', 'other']),
  "title": zod.string(),
  "description": zod.string(),
  "responsibleUserId": zod.number().nullish(),
  "responsibleUserName": zod.string().nullish(),
  "status": zod.enum(['open', 'under_analysis', 'action_in_progress', 'awaiting_effectiveness', 'closed', 'canceled']),
...
export const createNonconformityBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateNonconformityBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createNonconformityBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createNonconformityBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})
...
export const getNonconformityResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const getNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax = 20971520;

export const getNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const GetNonconformityResponse = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getNonconformityResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getNonconformityResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActions": zod.array(zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "description": zod.string(),
  "responsibleUserId": zod.number().nullish(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp)
})),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
}))
...
export const updateNonconformityBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateNonconformityBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateNonconformityBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateNonconformityBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})

export const updateNonconformityResponseTwoAttachmentsItemOneFileSizeMax = 20971520;

export const updateNonconformityResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const updateNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax = 20971520;

export const updateNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateNonconformityResponse = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateNonconformityResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateNonconformityResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActions": zod.array(zod.object({
  "id": zod.number(),
  "title": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateNonconformityResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp)
})),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
}))
...
export const createNonconformityEffectivenessReviewResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const createNonconformityEffectivenessReviewResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const CreateNonconformityEffectivenessReviewResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "originType": zod.enum(['audit_finding', 'incident', 'document', 'process', 'risk', 'other']),
  "title": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createNonconformityEffectivenessReviewResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createNonconformityEffectivenessReviewResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActions": zod.array(zod.object({
  "id": zod.number(),
  "title": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createNonconformityEffectivenessReviewResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createNonconformityEffectivenessReviewResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp)
})),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
}))
...
export const listCorrectiveActionsResponseAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const ListCorrectiveActionsResponseItem = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(listCorrectiveActionsResponseAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(listCorrectiveActionsResponseAttachmentsItemOneObjectPathRegExp)
})),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
})
export const ListCorrectiveActionsResponse = zod.array(ListCorrectiveActionsResponseItem)
...
export const createCorrectiveActionBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateCorrectiveActionBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createCorrectiveActionBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createCorrectiveActionBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})
...
export const updateCorrectiveActionBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateCorrectiveActionBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateCorrectiveActionBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateCorrectiveActionBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})

export const updateCorrectiveActionResponseTwoAttachmentsItemOneFileSizeMax = 20971520;

export const updateCorrectiveActionResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
export const updateCorrectiveActionResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax = 20971520;

export const updateCorrectiveActionResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateCorrectiveActionResponse = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateCorrectiveActionResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateCorrectiveActionResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "correctiveActions": zod.array(zod.object({
  "id": zod.number(),
  "title": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateCorrectiveActionResponseTwoCorrectiveActionsItemAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateCorrectiveActionResponseTwoCorrectiveActionsItemAttachmentsItemOneObjectPathRegExp)
})),
  "createdAt": zod.string().nullish(),
  "updatedAt": zod.string().nullish()
}))
...
export const createManagementReviewBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const CreateManagementReviewBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(createManagementReviewBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(createManagementReviewBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})
...
export const getManagementReviewResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const GetManagementReviewResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "reviewDate": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(getManagementReviewResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(getManagementReviewResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "inputs": zod.array(zod.object({
  "id": zod.number(),
  "reviewId": zod.number(),
  "inputType": zod.enum(['policy', 'audit_summary', 'nc_summary', 'objective_status', 'risk_status', 'process_performance', 'customer_feedback', 'other']),
  "summary": zod.string(),
  "documentId": zod.number().nullish(),
...
export const updateManagementReviewBodyAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');
...
export const UpdateManagementReviewBody = zod.object({
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateManagementReviewBodyAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateManagementReviewBodyAttachmentsItemOneObjectPathRegExp)
})).optional()
})

export const updateManagementReviewResponseTwoAttachmentsItemOneFileSizeMax = 20971520;

export const updateManagementReviewResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateManagementReviewResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "reviewDate": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateManagementReviewResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateManagementReviewResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "inputs": zod.array(zod.object({
  "id": zod.number(),
  "reviewId": zod.number(),
...
export const ListManagementReviewInputsResponse = zod.array(ListManagementReviewInputsResponseItem)
...
export const UpdateManagementReviewInputBody = zod.object({
  "inputType": zod.enum(['policy', 'audit_summary', 'nc_summary', 'objective_status', 'risk_status', 'process_performance', 'customer_feedback', 'other']).optional(),
...
export const updateManagementReviewInputResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateManagementReviewInputResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "reviewDate": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateManagementReviewInputResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateManagementReviewInputResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "inputs": zod.array(zod.object({
  "id": zod.number(),
  "reviewId": zod.number(),
...
export const ListManagementReviewOutputsResponse = zod.array(ListManagementReviewOutputsResponseItem)
...
export const UpdateManagementReviewOutputBody = zod.object({
  "outputType": zod.enum(['decision', 'action', 'resource', 'priority']).optional(),
  "description": zod.string().optional(),
  "responsibleUserId": zod.number().nullish(),
  "dueDate": zod.string().nullish(),
  "processId": zod.number().nullish(),
...
export const updateManagementReviewOutputResponseTwoAttachmentsItemOneObjectPathRegExp = new RegExp('^\/objects\/uploads\/.+');


export const UpdateManagementReviewOutputResponse = zod.object({
  "id": zod.number(),
  "organizationId": zod.number(),
  "title": zod.string(),
  "reviewDate": zod.string(),
  ...
  "attachments": zod.array(zod.object({
  "fileName": zod.string(),
  "fileSize": zod.number().max(updateManagementReviewOutputResponseTwoAttachmentsItemOneFileSizeMax),
  "contentType": zod.string(),
  "objectPath": zod.string().regex(updateManagementReviewOutputResponseTwoAttachmentsItemOneObjectPathRegExp)
})),
  "inputs": zod.array(zod.object({
  "id": zod.number(),
  "reviewId": zod.number(),
 ...
 */
export const CreateStrategicPlanRiskOpportunityEffectivenessReviewParams = zod.object({
  "orgId": zod.coerce.number(),
  "planId": zod.coerce.number(),
  "itemId": zod.coerce.number()
})

export const CreateStrategicPlanRiskOpportunityEffectivenessReviewBody = zod.object({
  "result": zod.enum(['effective', 'ineffective']),
  "comment": zod.string().nullish()
})
...
export const CreateStrategicPlanRiskOpportunityEffectivenessReviewResponse = zod.object({
  "id": zod.number(),
  "planId": zod.number(),
  "type": zod.enum(['risk', 'opportunity']),
  "sourceType": zod.enum(['swot', 'audit', 'meeting', 'legislation', 'incident', 'internal_strategy', 'other']),
  ...
  "objectiveId": zod.number().nullish(),
  "swotItemId": zod.number().nullish(),
  "likelihood": zod.number().min(1).max(createStrategicPlanRiskOpportunityEffectivenessReviewResponseLikelihoodMax).nullish(),
  "impact": zod.number().min(1).max(createStrategicPlanRiskOpportunityEffectivenessReviewResponseImpactMax).nullish(),
  "score": zod.number().nullish().describe('Derived by the server from likelihood x impact.'),
  "priority": zod.enum(['na', 'low', 'medium', 'high', 'critical']).describe('Derived by the server from the calculated score.'),
  "responseStrategy": zod.enum(['mitigate', 'eliminate', 'accept', 'monitor', 'exploit', 'enhance', 'share', 'avoid', 'other']).nullish(),
  "nextReviewAt": zod.string().nullish(),
...
export const ListKpiObjectivesResponse = zod.array(ListKpiObjectivesResponseItem)
...
export const ListKpiIndicatorsResponseItem = zod.object({
  ...
  "periodicity": zod.enum(['monthly', 'quarterly', 'semiannual', 'annual', 'monthly_15d', 'monthly_45d']),
  "createdAt": zod.string(),
  "updatedAt": zod.string()
})
export const ListKpiIndicatorsResponse = zod.array(ListKpiIndicatorsResponseItem)
...
export const UpdateKpiIndicatorBody = zod.object({
  ...
  "periodicity": zod.enum(['monthly', 'quarterly', 'semiannual', 'annual', 'monthly_15d', 'monthly_45d']).optional()
})
...
export const ListKpiYearDataResponseItem = zod.object({
  ...
  "monthlyValues": zod.array(zod.object({
  "month": zod.number().min(1).max(listKpiYearDataResponseMonthlyValuesItemMonthMax),
