...
// A definição vive em services/aprendizagem/effectiveness-board.ts desde que o
// provider de pendências passou a precisar da mesma regra (um serviço não pode
// importar um arquivo de rotas). Aqui ficam o import local (usado nas queries
// abaixo) e o re-export, para os call sites/históricos que apontam para cá.
import {
  boardConcluidas,
  boardEmAvaliacao,
